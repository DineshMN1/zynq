...
/**
 * Render a centered, animated drop-zone overlay when active.
 *
 * @param isActive - Whether the overlay should be visible
 * @returns The overlay element when `isActive` is true, `null` otherwise
 */
