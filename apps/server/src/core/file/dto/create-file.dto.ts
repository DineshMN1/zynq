import { IsString, IsNumber, IsOptional, IsBoolean, IsIn, Max, Matches } from 'class-validator';
...
const BLOCKED_EXTENSIONS_REGEX = /\.(exe|bat|cmd|sh|ps1|vbs|vbe|js|jse|wsf|wsh|msc|pif|scr|reg|dll|com|msi|jar|hta|cpl|inf|lnk)$/i;
